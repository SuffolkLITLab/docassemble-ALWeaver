...
Scenario: I weave the civil docketing statement
  ...
  And I get to the question id "download-your-interview" with this data:
    ...
    | interview.questions[0].field_list['interview.all_fields[0]'] | True |
    | interview.questions[2].field_list['interview.all_fields[10]'] | True |
    | interview.questions[2].field_list['interview.all_fields[11]'] | True |
    | interview.questions[2].field_list['interview.all_fields[12]'] | True |
    | interview.questions[2].field_list['interview.all_fields[13]'] | True |
    | interview.questions[2].field_list['interview.all_fields[14]'] | True |
    | interview.questions[2].field_list['interview.all_fields[15]'] | True |
    | interview.questions[2].field_list['interview.all_fields[16]'] | True |
    | interview.questions[2].field_list['interview.all_fields[17]'] | True |
    | interview.questions[2].field_list['interview.all_fields[18]'] | True |
    | interview.questions[2].field_list['interview.all_fields[19]'] | True |
    | interview.questions[0].field_list['interview.all_fields[1]'] | True |
    | interview.questions[3].field_list['interview.all_fields[20]'] | True |
    | interview.questions[3].field_list['interview.all_fields[21]'] | True |
    | interview.questions[3].field_list['interview.all_fields[22]'] | True |
    | interview.questions[3].field_list['interview.all_fields[23]'] | True |
    | interview.questions[3].field_list['interview.all_fields[24]'] | True |
    | interview.questions[3].field_list['interview.all_fields[25]'] | True |
    | interview.questions[3].field_list['interview.all_fields[26]'] | True |
    | interview.questions[3].field_list['interview.all_fields[27]'] | True |
    ...
    | interview.questions[3].field_list['interview.all_fields[33]'] | True |
    | interview.questions[3].field_list['interview.all_fields[34]'] | True |
    | interview.questions[0].field_list['interview.all_fields[3]'] | True |
    | interview.questions[0].field_list['interview.all_fields[4]'] | True |
    | interview.questions[0].field_list['interview.all_fields[5]'] | True |
    | interview.questions[2].field_list['interview.all_fields[6]'] | True |
    | interview.questions[2].field_list['interview.all_fields[7]'] | True |
    | interview.questions[2].field_list['interview.all_fields[8]'] | True |
    | interview.questions[2].field_list['interview.all_fields[9]'] | True |
    | interview.questions[3].field_list['interview.all_fields[35]'] | True |
    | interview.questions[3].field_list['interview.all_fields[36]'] | True |
    | interview.questions[3].field_list['interview.all_fields[37]'] | True |
    ...
    | interview.questions[0].question_text | Screen 1 custom title |
    | interview.questions[2].question_text | Screen 3 custom title |
    | interview.questions[3].question_text | Screen 4 custom title |
    | interview.questions[0].subquestion_text | Screen 1 text |
    | interview.questions[2].subquestion_text | Screen 3 body |
    | interview.questions[3].subquestion_text | Screen 4 body text |
    | interview.questions[1].is_informational_screen | True |
