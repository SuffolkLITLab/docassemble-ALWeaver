...
class TestEditorOutlineHeader(unittest.TestCase):
    def test_outline_header_switches_by_view(self):
        ...
        self.assertIn("return all.map(function (name) { return { name: name, group: 'variables' }; });", editor_js)
        self.assertIn("data-field-prop=\"variable\" data-symbol-role=\"variable\"", editor_js)
        ...
        self.assertIn("native scrolling and scrollbar dragging inside the suggestion list", editor_js)
        self.assertNotIn("target.closest('#editor-symbol-typeahead') || target.id === 'editor-symbol-typeahead'", editor_js)
