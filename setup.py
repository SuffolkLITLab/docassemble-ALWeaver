...
setup(name='docassemble.ALWeaver',
      ...
      install_requires=['PyYAML>=5.1.2', 'beautifulsoup4>=4.9.3', 'docassemble.ALToolbox>=0.3.6', 'docx2python>=1.27.1', 'formfyxer', 'more-itertools>=8.6.0', 'numpy>=1.0.4', 'sklearn>=0.0', 'spacy>=3.2.0'],
      zip_safe=False,
