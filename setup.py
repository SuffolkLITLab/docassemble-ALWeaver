...
setup(name='docassemble.ALWeaver',
      ...
      install_requires=['PyYAML>=5.1.2', 'beautifulsoup4>=4.9.3', 'docassemble.ALToolbox>=0.4.1', 'docassemble.AssemblyLine>=2.11.2', 'docx2python>=1.27.1', 'formfyxer>=0.0.6', 'more-itertools>=8.12.0', 'numpy>=1.0.4', 'pikepdf>=5.0.1', 'sklearn>=0.0', 'spacy>=3.2.3'],
      zip_safe=False,
