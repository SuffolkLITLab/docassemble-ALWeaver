...
setup(name='docassemble.ALWeaver',
      ...
      install_requires=['PyYAML>=5.1.2', 'beautifulsoup4>=4.11.1', 'docassemble.ALToolbox>=0.4.0', 'docassemble.AssemblyLine>=2.10.2', 'docx2python>=1.27.1', 'formfyxer', 'more-itertools>=8.6.0', 'numpy>=1.0.4', 'pikepdf>=5.1.1', 'sklearn>=0.0', 'spacy>=3.2.0'],
      zip_safe=False,
